...
export function LeftSidebar() {
  ...
  return <aside className="h-full border-r border-sidebar-border bg-sidebar shadow-lg sidebar-reveal flex flex-col" style={{
